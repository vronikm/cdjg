									...
									<div class="row">
										...
										<div class="col-md-3">
											<div class="form-group">
												...
												<div class="form-check">
													<input class="col-sm-1 form-check-input" type="radio" id="repre_requiere_facturaS" name="repre_requiere_factura" value="S" <?php echo $repre_requiere_facturaS; ?> disabled="">
													<label class="col-sm-5 form-check-label" for="repre_requiere_facturaS" style="font-size: 14px;">Si</label>
													<input class="col-sm-1 form-check-input" type="radio" id="repre_requiere_facturaN" name="repre_requiere_factura" value="N" <?php echo $repre_requiere_facturaN; ?> disabled="">
										...
										<div class="col-md-3">
											<div class="form-group">
												...
												<select class="form-control" id="repre_factura_a_nombre" name="repre_factura_a_nombre" disabled="">
